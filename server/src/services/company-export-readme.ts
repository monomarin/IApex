 ...
 */
import type { CompanyPortabilityManifest } from "@iapexai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [IApex](https://IApex.ing)");
  lines.push("");
