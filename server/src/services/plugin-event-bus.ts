/**
 * PluginEventBus — typed in-process event bus for the IApex plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@iapexai/shared";
import type { PluginEvent, EventFilter } from "@iapexai/plugin-sdk";
