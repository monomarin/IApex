...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@iapexai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: IApexPluginManifestV1, pluginDbId?: string): void;
