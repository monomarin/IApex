...
import { models as codexFallbackModels } from "@iapexai/adapter-codex-local";
import { models as cursorFallbackModels } from "@iapexai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@iapexai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.IApex_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.IApex_OPENCODE_COMMAND = "__IApex_missing_opencode_command__";
