...
Low-level reference for how IApex packages are prepared and published to npm.
...
IApex no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `IApexai`, imports code from workspace packages such as:
