...
This is intentionally separate from the normal IApex dev image.
...
```sh
review-checkout-pr IApexai/IApex 432
cd /work/checkouts/IApexai-IApex/pr-432
```
...
## Preview the IApex app from the PR
...
- IApex's embedded PostgreSQL and local storage stay inside the container home volume via `IApex_HOME=/home/reviewer/.IApex-review`.
