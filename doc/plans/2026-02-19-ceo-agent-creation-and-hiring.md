...
- installed adapter list for this IApex instance
...
## 8. New Skill: `IApex-create-agent`

Create new skill directory:

- `skills/IApex-create-agent/SKILL.md`
- `skills/IApex-create-agent/references/api-reference.md`
...
Also update `skills/IApex/SKILL.md` to reference this skill for hiring workflows.
...
- `IApex-create-agent` skill + docs updates
