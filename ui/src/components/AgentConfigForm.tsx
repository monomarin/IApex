...
import { AGENT_ADAPTER_TYPES } from "@iapexai/shared";
import type {
  Agent,
...
// Canonical type lives in @iapexai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@iapexai/adapter-utils";
import type { CreateConfigValues } from "@iapexai/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        IApex_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
