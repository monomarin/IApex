...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@iapexai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@iapexai/adapter-utils").TranscriptEntry[];
