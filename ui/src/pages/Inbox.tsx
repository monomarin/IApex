...
import type { Approval, HeartbeatRun, Issue, JoinRequest } from "@iapexai/shared";
import {
...
export function Inbox() {
  ...
  return (
    <div className="space-y-6 p-2">
      <div>
        <h2 className="text-[22px] font-bold text-slate-100 m-0">Intelligent Inbox</h2>
        <p className="text-[12px] text-slate-500 mt-1 font-mono">
          Triage IA via CLAW · {unreadIssueIds.length} unread
        </p>
      </div>
