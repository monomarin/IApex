...
import { AGENT_ROLES } from "@iapexai/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("IApexai/IApex/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in IApex runtime skills are added automatically.
              </p>
            </div>
