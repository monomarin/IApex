 ...
 *
 * This is placed on `globalThis.__IApexPluginBridge__` and consumed by
...
declare global {
  ...
  var __IApexPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__IApexPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__IApexPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
