...
This document describes how `@iapexai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into IApex logs/transcript parsing
