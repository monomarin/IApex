/**
 * `definePlugin` — the top-level helper for authoring a IApex plugin.
 *
...
// ---------------------------------------------------------------------------
// IApexPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `IApexPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@iapexai/plugin-sdk";
