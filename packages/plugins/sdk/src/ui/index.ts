/**
 * `@iapexai/plugin-sdk/ui` — IApex plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@iapexai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@iapexai/plugin-sdk/ui";
 *
