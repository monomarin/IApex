...
import type { IApexPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@iapexai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: IApexPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@iapexai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
