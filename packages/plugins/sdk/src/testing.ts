...
function requireCapability(manifest: IApexPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the IApex server runtime.
 */
