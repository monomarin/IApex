import type { PluginLauncherRegistration } from "@iapexai/plugin-sdk";

export const PLUGIN_ID = "IApex-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".IApex-kitchen-sink-demo.txt",
} as const;
