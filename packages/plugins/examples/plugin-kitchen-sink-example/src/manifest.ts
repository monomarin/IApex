...
const manifest: IApexPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current IApex plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "IApex",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the IApex domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
