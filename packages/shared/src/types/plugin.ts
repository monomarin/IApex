...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within IApexPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the IApex host.
 *
...
export interface IApexPluginManifestV1 {
   ...
   */
  minimumIApexVersion?: PluginMinimumHostVersion;
