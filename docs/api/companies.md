...
Manage companies within your IApex instance.
...
Company logo uploads use the normal IApex attachment size limit.
...
| `logoUrl` | string | Optional IApex asset content path for the stored logo image |
