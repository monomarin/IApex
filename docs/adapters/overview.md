...
summary: What adapters are and how they connect agents to IApex
---

Adapters are the bridge between IApex's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, IApex:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `IApexai run --watch`
```
